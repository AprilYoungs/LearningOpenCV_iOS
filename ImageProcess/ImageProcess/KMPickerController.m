...
{
    NSAttributedString* attstr = [[NSAttributedString alloc] initWithString:self.dataArr[row] attributes:@{NSForegroundColorAttributeName:HEX_COLOR(0x3090FF),NSFontAttributeName:[UIFont systemFontOfSize:14]}];
    return attstr;
}
